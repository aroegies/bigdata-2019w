...
Sample usage:
$ ./check_assignment3_public_linux.py bigdatateach
"""
...
if __name__ == "__main__":
  parser = argparse.ArgumentParser(description="CS 451 A3 Public Check Script for the Linux Student CS Environment")
